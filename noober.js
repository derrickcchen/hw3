function pageLoad() {
  ...
  } else if (ride[1].numberOfPassengers > 3) {
    levelOfService = 'Noober XL'
  } else if (ride[2].numberOfPassengers > 3) {
    levelOfService = 'Noober XL'
  } else {
    levelOfService = 'Noober X'
  }

  // From the data, it appears that if a ride request for 3 or more people, 
  // then this will show up in the first "leg" in the ride ("ride[0].numberOfPassengers"), 
  // but just in case the ride request for 3 or more people can show up in the "second" ("ride[1].numberOfPassengers")
  // or "third" legs ("ride[2].numberOfPassengers"), I have added the code in the rows above.
